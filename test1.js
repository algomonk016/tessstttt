...
class LimeChatWhatsapp {
  ...
  async initializeWidget() {
    (await this.getConfig()) && this.renderWidget();
  }
  deviceCheck(t) {
  ...
  renderWidget() {
    this.deviceCheck(this.display_on) && this.renderButton();
  }
  pageCheck(t) {
    let e = !1;
    return (
      t.forEach((t) => {
        'homepage' == t && '/' == window.location.pathname && (e = !0),
          'collections' == t &&
          ...
          'products' == t &&
            ...
            (e = !0),
          'cart' == t && '/cart' == window.location.pathname && (e = !0),
          'pages' == t &&
  ...
  renderButton() {
    console.log(
      'render button -- check ::',
      this.pageCheck(this.pages_to_display),
      this.pages_to_display
    );
    if (this.pageCheck(this.pages_to_display) || !this.isShopify) {
      ...
      // Common setup for all pages - moved outside of else block
