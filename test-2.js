...
class LimeChatWhatsapp {
  ...
  pageCheck(t) {
    ...
    t.forEach((t) => {
      ...
      if ('products' == t && window.location.pathname.includes('/products/')) {
      ...
      if ('pages' == t && window.location.pathname.includes('/pages/')) {
      ...
      if ('blogs' == t && window.location.pathname.includes('/blogs/')) {
